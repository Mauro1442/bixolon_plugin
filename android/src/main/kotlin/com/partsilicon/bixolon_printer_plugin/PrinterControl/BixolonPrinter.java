package com.partsilicon.bixolon_printer_plugin.PrinterControl;
...
import static com.partsilicon.bixolon_printer_plugin.BixolonPrinterPluginKt.LOGTAG;
...
//    }
    ...
    public void directIOOccurred(DirectIOEvent directIOEvent) {
        Log.d(LOGTAG,directIOEvent.toString());
    ...
    public void errorOccurred(ErrorEvent errorEvent) {
        Log.d(LOGTAG,errorEvent.toString());
        /*Fragment fm = MainActivity.getVisibleFragment();
        if (fm != null) {
    ...
    public void outputCompleteOccurred(OutputCompleteEvent outputCompleteEvent) {
        Log.d(LOGTAG,outputCompleteEvent.toString());
        /*Fragment fm = MainActivity.getVisibleFragment();
        if (fm != null) {
            if (fm instanceof TextFragment) {
    ...
    public void statusUpdateOccurred(StatusUpdateEvent statusUpdateEvent) {
        Log.d(LOGTAG,statusUpdateEvent.toString());
        /*Fragment fm = MainActivity.getVisibleFragment();
        if (fm != null) {
            if (fm instanceof TextFragment) {
    ...
    public void dataOccurred(DataEvent dataEvent) {
        Log.d(LOGTAG,dataEvent.toString());
        /*Fragment fm = MainActivity.getVisibleFragment();
        if (fm != null) {
            if (fm instanceof MsrFragment) {
